...
<body class="bg-gray-50">
    ...
    <div>
        ...
        <p class="text-sm text-gray-600">
            Table <?php echo e($tableInfo['table_number']); ?>
                ...
                <a href="<?php echo e(route('cart.index')); ?>" class="relative inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
                    ...
                    Cart
                    <span class="cart-count absolute -top-2 -right-2 bg-red-500 text-white text-xs rounded-full h-6 w-6 flex items-center justify-center <?php echo e($cartCount > 0 ? '' : 'hidden'); ?>"><?php echo e($cartCount); ?></span>
                </a>
            </div>
    ...
    <?php if(isset($pendingOrder) && $pendingOrder): ?>
        <div class="max-w-3xl mx-auto px-4 mt-4">
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3 flex-1">
                        ...
                        <p class="text-sm text-amber-700 mb-3">
                            You have an unpaid order <strong class="font-mono">#<?php echo e($pendingOrder->order_number); ?></strong>
                            <br>
                            <span class="text-amber-600">Total: Rp <?php echo e(number_format($pendingOrder->total_amount, 0, ',', '.')); ?></span>
                        </p>
                        <div class="flex flex-col sm:flex-row gap-2">
                            <a href="<?php echo e(route('payment', $pendingOrder->id)); ?>" class="inline-flex items-center justify-center px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white font-bold rounded-lg transition shadow-md">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/>
                                </svg>
                                Complete Payment Now
                            </a>
                            <button onclick="if(confirm('Are you sure you want to cancel this order? This action cannot be undone.')) { document.getElementById('cancel-form-<?php echo e($pendingOrder->id); ?>').submit(); }" class="inline-flex items-center justify-center px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium rounded-lg transition">
                                Cancel Order
                            </button>
                            <form id="cancel-form-<?php echo e($pendingOrder->id); ?>" action="<?php echo e(route('order.cancel', $pendingOrder->id)); ?>" method="POST" class="hidden">
                                <?php echo csrf_field(); ?>
        ...
        <div class="bg-white rounded-lg shadow-sm p-4">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button onclick="filterByCategory('<?php echo e($category->id); ?>')" class="category-filter-btn px-4 py-2 rounded-full text-sm font-medium transition-all" data-category="<?php echo e($category->id); ?>">
    ...
    <div class="max-w-3xl mx-auto px-4 py-6 pb-24">
        <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php if($category->menus->count() > 0): ?>
                <!-- Category Header -->
                <div class="mb-6 category-section" data-category-id="<?php echo e($category->id); ?>">
                        ...
                        <?php $__currentLoopData = $category->menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition menu-item" data-name="<?php echo e(strtolower($menu->name)); ?>" data-description="<?php echo e(strtolower($menu->description ?? '')); ?>">
                                <div class="flex">
                                    ...
                                    <div class="flex flex-1 cursor-pointer" onclick="showMenuDetail(<?php echo e($menu->id); ?>)">
                                        <!-- Image -->
                                    ...
                                    <div class="flex items-center pr-4">
                                        ...
                                        <?php if($inCart): ?>
                                            ...
                                            <div class="flex items-center bg-blue-50 rounded-lg">
                                                <button onclick="updateQuantity(<?php echo e($menu->id); ?>, -1)" class="px-3 py-2 text-blue-600 hover:bg-blue-100 rounded-l-lg transition">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H4"/>
                                                    </svg>
                                                </button>
                                                <span class="px-4 py-2 text-blue-700 font-bold min-w-[40px] text-center" id="qty-<?php echo e($menu->id); ?>"><?php echo e($quantity); ?></span>
                                                <button onclick="updateQuantity(<?php echo e($menu->id); ?>, 1)" class="px-3 py-2 text-blue-600 hover:bg-blue-100 rounded-r-lg transition">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <?php else: ?>
                                            <!-- Add Button -->
                                            <form class="add-to-cart-form" data-menu-id="<?php echo e($menu->id); ?>">
                                                <?php echo csrf_field(); ?>
                                ...
                                <div class="hidden menu-data" 
                                     ...
                                     data-description="<?php echo e($menu->description ?? 'No description available.'); ?>"
                                     data-price="<?php echo e($menu->price); ?>"
                                     data-price-formatted="Rp <?php echo e(number_format($menu->price, 0, ',', '.')); ?>"
                                     data-category="<?php echo e($menu->category->name ?? 'Uncategorized'); ?>"
                                     data-image="<?php echo e($menu->image_path && file_exists(public_path($menu->image_path)) ? asset($menu->image_path) : ''); ?>"
                                     data-available="<?php echo e($menu->is_available ? 'true' : 'false'); ?>">
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
    ...
    <div id="floatingCart" class="fixed bottom-4 right-4 sm:hidden <?php echo e($cartCount > 0 ? '' : 'hidden'); ?>">
        <a href="<?php echo e(route('cart.index')); ?>" class="bg-blue-600 text-white rounded-full p-4 shadow-lg flex items-center justify-center relative">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/>
            </svg>
            <span class="cart-count absolute -top-2 -right-2 bg-red-500 text-white text-xs rounded-full h-6 w-6 flex items-center justify-center"><?php echo e($cartCount); ?></span>
        </a>
    </div>
