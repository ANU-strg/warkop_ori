...
<body class="bg-gray-50">
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
            <div class="mb-6">
                ...
                <p class="text-gray-600">Order #<?php echo e($order->transaction_id); ?></p>
            </div>
            ...
            <div class="bg-gray-50 rounded-lg p-4 mb-6">
                ...
                <div class="flex justify-between items-center mb-2">
                    ...
                    <span class="font-semibold"><?php echo e($order->orderItems->count()); ?> items</span>
                </div>
                <div class="flex justify-between items-center border-t pt-2">
                    <span class="text-lg font-bold">Total</span>
                    <span class="text-2xl font-bold text-blue-600">Rp <?php echo e(number_format($order->total_amount, 0, ',', '.')); ?></span>
                </div>
            </div>
    ...
    <script type="text/javascript">
        document.getElementById('pay-button').onclick = function(){
            <?php if($order->snap_token && !str_starts_with($order->snap_token, 'dummy')): ?>
                snap.pay('<?php echo e($order->snap_token); ?>', {
                    onSuccess: function(result){
                        // Update status via AJAX before redirect
                        fetch('<?php echo e(route("midtrans.finish")); ?>?order_id=<?php echo e($order->transaction_id); ?>', {
                            method: 'GET'
                        }).then(() => {
                            window.location.href = '<?php echo e(route("order.success", $order->id)); ?>';
                        });
                    },
...
<?php /**PATH D:\KULIAH\Semester 7\Proyek Teknologi Informasi\warkop_ori\resources\views/payment.blade.php ENDPATH**/ ?>