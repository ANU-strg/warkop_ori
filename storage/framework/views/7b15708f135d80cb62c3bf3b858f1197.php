    ...
    <div class="max-w-3xl mx-auto px-4 py-6">
        <?php if(!empty($cart)): ?>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4">
                        <div class="flex items-center">
                            ...
                            <?php if($item['image_path'] && file_exists(public_path($item['image_path']))): ?>
                                <img src="<?php echo e(asset($item['image_path'])); ?>" alt="<?php echo e($item['name']); ?>" class="w-20 h-20 object-cover rounded">
                            <?php else: ?>
                            ...
                            <div class="flex-1 ml-4">
                                ...
                                <p class="text-blue-600 font-medium">Rp <?php echo e(number_format($item['price'], 0, ',', '.')); ?></p>
            ...
            <div class="flex space-x-2">
                ...
                <a href="<?php echo e(route('checkout')); ?>" class="flex-1 bg-blue-600 text-white px-6 py-3 rounded-lg text-center font-medium hover:bg-blue-700">
                    Proceed to Checkout
                </a>
            </div>
        <?php else: ?>
